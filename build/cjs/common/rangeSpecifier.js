...
exports.ByteRangeSpecifier = exports.ChunkRangeSpecifier = exports.PdAccessListArgBase = void 0;
...
exports.PdAccessListArgBase = PdAccessListArgBase;
class ChunkRangeSpecifier extends PdAccessListArgBase {
    ...
    encode() {
        ...
        buffer[0] = this.type;
        const partitionBytes = (0, utils_1.bigIntToBytes)(this.partitionIndex, 25);
    ...
    static decode(buffer) {
        ...
        const partitionIndex = (0, utils_1.bytesToBigInt)(buffer.slice(1, 26));
        const offsetView = new DataView(buffer.buffer, 26, 4);
...
exports.ChunkRangeSpecifier = ChunkRangeSpecifier;
class ByteRangeSpecifier extends PdAccessListArgBase {
    ...
    encode() {
        ...
        buffer.set((0, utils_1.bigIntToBytes)(byteOffsetBig, 3), 4);
        // Length (5 bytes)
        const lengthBig = BigInt(this.length);
        buffer.set((0, utils_1.bigIntToBytes)(lengthBig, 5), 7);
        return buffer;
    }
    static decode(buffer) {
        // eslint-disable-next-line @typescript-eslint/no-unsafe-enum-comparison
        ...
        const byteOffset = Number((0, utils_1.bytesToBigInt)(buffer.slice(4, 7)));
        // Read length (5 bytes)
        const length = Number((0, utils_1.bytesToBigInt)(buffer.slice(7, 12)));
...
exports.ByteRangeSpecifier = ByteRangeSpecifier;
